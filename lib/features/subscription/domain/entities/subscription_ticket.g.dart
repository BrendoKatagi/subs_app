...
part of 'subscription_ticket.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

SubscriptionTicket _$SubscriptionTicketFromJson(Map<String, dynamic> json) =>
    SubscriptionTicket(
...
Map<String, dynamic> _$SubscriptionTicketToJson(SubscriptionTicket instance) =>
    <String, dynamic>{
      'id': instance.id,
